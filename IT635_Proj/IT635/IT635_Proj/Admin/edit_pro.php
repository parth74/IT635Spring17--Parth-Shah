...
<body bgcolor="skyblue">
	...
	<form action="" method="post" enctype="multipart/form-data"> 
		...
		$cat_title = $row_cats['categ_title'];
...
<?php 
	...
	if(isset($_POST['update_product'])){
		...
		$product_cat= $_POST['product_categ'];
		...
		move_uploaded_file($product_image_tmp,"product_img/$product_image");
		 ...
		 $update_product = "update products set product_categ='$product_cat',product_brand='$product_brand',product_title='$product_title',product_price='$product_price',product_desc='$product_desc',product_image='$product_image', product_keywords='$product_keywords' where product_id='$update_id'";
